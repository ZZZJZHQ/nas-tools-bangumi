...
INSERT OR IGNORE INTO "CONFIG_FILTER_GROUP" ("ID","GROUP_NAME","IS_DEFAULT","NOTE") VALUES
 (1002,'BANGUMI','Y',NULL);
INSERT OR IGNORE INTO "CONFIG_FILTER_RULES" ("ID","GROUP_ID","ROLE_NAME","PRIORITY","INCLUDE","EXCLUDE","SIZE_LIMIT","NOTE") VALUES
 (10034,'1002','BANGUMI-720P','1','720
1','\d+-\d',NULL,NULL),
 (10035,'1002','BANGUMI-桜都字幕组','2','桜都字幕组','^(?=.*\[桜都字幕组\])(?=.*(?:繁体内嵌|繁日内嵌)).*',NULL,NULL),
 (10036,'1002','BANGUMI-喵萌奶茶屋','3','^(?=.*\[桜都字幕组\])(?=.*(?:简体内嵌|简日内嵌))(?!.*1080p@60FPS).*','^(?=.*\[桜都字幕组\])(?=.*(?:简体内嵌|简日内嵌))(?!.*1080p@60FPS).*',NULL,NULL),
 (10037,'1002','BANGUMI-北宇治字幕组','4','^(?=.*喵萌奶茶屋)(?=.*(?:繁日双语|繁体))(?!.*LoliHouse).*','^(?=.*喵萌奶茶屋)(?=.*(?:繁日双语|繁体))(?!.*LoliHouse).*',NULL,NULL),
 (10038,'1002','BANGUMI-爱恋&漫猫字幕组','5','^(?=.*\[北宇治字幕组\])(?=.*繁体内嵌).*','^(?=.*\[北宇治字幕组\])(?=.*繁体内嵌).*',NULL,NULL),
 (10039,'1002','BANGUMI-拨雪寻春','6','^(?=.*(?:\[爱恋\&漫猫字幕组\]|\[漫猫字幕社\&猫恋汉化组\]))(?=.*繁日双语).*','^(?=.*(?:\[爱恋\&漫猫字幕组\]|\[漫猫字幕社\&猫恋汉化组\]))(?=.*繁日双语).*',NULL,NULL),
 (10040,'1002','BANGUMI-MingY','7','^(?=.*\[\❀拨雪寻春\❀\])(?=.*繁日内嵌).*','^(?=.*\[\❀拨雪寻春\❀\])(?=.*繁日内嵌).*',NULL,NULL),
 (10041,'1002','BANGUMI-Up to 21°C','8','^(?=.*\[MingY\])(?=.*繁体内嵌).*','^(?=.*\[MingY\])(?=.*繁体内嵌).*',NULL,NULL),
 (10042,'1002','BANGUMI-B-Global','9','^(?=.*\[Up to 21\°C\])(?!.*\b(?:B\-Global)\b).*','^(?=.*\[Up to 21\°C\])(?!.*\b(?:B\-Global)\b).*',NULL,NULL),
 (10043,'1002','BANGUMI-720P','10','720
1','\d+-\d',NULL,NULL),
 (10044,'1002','BANGUMI-桜都字幕组','11','桜都字幕组','^(?=.*\[桜都字幕组\])(?=.*(?:繁体内嵌|繁日内嵌)).*',NULL,NULL),
 (10045,'1002','BANGUMI-喵萌奶茶屋','12','^(?=.*\[桜都字幕组\])(?=.*(?:简体内嵌|简日内嵌))(?!.*1080p@60FPS).*','^(?=.*\[桜都字幕组\])(?=.*(?:简体内嵌|简日内嵌))(?!.*1080p@60FPS).*',NULL,NULL),
 (10046,'1002','BANGUMI-北宇治字幕组','13','^(?=.*喵萌奶茶屋)(?=.*(?:繁日双语|繁体))(?!.*LoliHouse).*','^(?=.*喵萌奶茶屋)(?=.*(?:繁日双语|繁体))(?!.*LoliHouse).*',NULL,NULL),
 (10047,'1002','BANGUMI-爱恋&漫猫字幕组','14','^(?=.*\[北宇治字幕组\])(?=.*繁体内嵌).*','^(?=.*\[北宇治字幕组\])(?=.*繁体内嵌).*',NULL,NULL),
 (10048,'1002','BANGUMI-拨雪寻春','15','^(?=.*(?:\[爱恋\&漫猫字幕组\]|\[漫猫字幕社\&猫恋汉化组\]))(?=.*繁日双语).*','^(?=.*(?:\[爱恋\&漫猫字幕组\]|\[漫猫字幕社\&猫恋汉化组\]))(?=.*繁日双语).*',NULL,NULL),
 (10049,'1002','BANGUMI-MingY','16','^(?=.*\[\❀拨雪寻春\❀\])(?=.*繁日内嵌).*','^(?=.*\[\❀拨雪寻春\❀\])(?=.*繁日内嵌).*',NULL,NULL),
 (10050,'1002','BANGUMI-Up to 21°C','17','^(?=.*\[MingY\])(?=.*繁体内嵌).*','^(?=.*\[MingY\])(?=.*繁体内嵌).*',NULL,NULL),
 (10051,'1002','BANGUMI-B-Global','18','^(?=.*\[Up to 21\°C\])(?!.*\b(?:B\-Global)\b).*','^(?=.*\[Up to 21\°C\])(?!.*\b(?:B\-Global)\b).*',NULL,NULL);
INSERT OR IGNORE INTO "CONFIG_FILTER_GROUP" ("ID","GROUP_NAME","IS_DEFAULT","NOTE") VALUES
 (9999,'不过滤','N',NULL);